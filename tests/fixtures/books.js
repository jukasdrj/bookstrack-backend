...
export const harryPotterBook = {
  ...
  subtitle: null,
  description:
    "A young wizard discovers his magical heritage on his eleventh birthday and attends Hogwarts School of Witchcraft and Wizardry.",
  authors: [
    {
      authorId: "OL34184A",
      name: "J.K. Rowling",
...
export const book1984 = {
  ...
  subtitle: null,
  description:
    "A dystopian social science fiction novel about totalitarianism, surveillance, and thought control.",
  authors: [
    {
      authorId: "OL118077A",
      name: "George Orwell",
...
export const greatGatsbyBook = {
  ...
  subtitle: null,
  description:
    "A tragic love story set in the Jazz Age, exploring themes of wealth, class, and the American Dream.",
  authors: [
    {
      authorId: "OL9388A",
...
export const invalidISBNs = [
  ...
  // Note: '9999999999999' is format-valid (13 digits) even though checksum is bad
  // The handler accepts format-valid ISBNs and lets providers determine actual validity
...
export function createMockWork(overrides = {}) {
  return {
    ...
    authors: overrides.authors || [
      { authorId: "OL1A", name: "Test Author", role: "author" },
    ],
